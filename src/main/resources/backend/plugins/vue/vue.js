...
(function (global, factory) {
   ...
   */
    ...
    var normalizeEvent = cached(function (name) {
        ...
        return {
            name: name, once: once$$1, capture: capture, passive: passive
        }
    });
    ...
    function initGlobalAPI(Vue) {
        ...
        Vue.util = {
            warn: warn, extend: extend, mergeOptions: mergeOptions, defineReactive: defineReactive$$1
        };
    ...
    function parseModel(val) {
        ...
        if (val.indexOf('[') < 0 || val.lastIndexOf(']') < len - 1) {
            ...
            if (index$1 > -1) {
                return {
                    exp: val.slice(0, index$1), key: '"' + val.slice(index$1 + 1) + '"'
                }
            } else {
                return {
                    exp: val, key: null
    ...
    var Transition = {
        name: 'transition', props: transitionProps, abstract: true,
    ...
    var klass$1 = {
        staticKeys: ['staticClass'], transformNode: transformNode, genData: genData
    };
    ...
    var style$1 = {
        staticKeys: ['staticStyle'], transformNode: transformNode$1, genData: genData$1
    };
    ...
    function preTransformNode(el, options) {
        if (el.tag === 'input') {
            ...
            if (typeBinding) {
                ...
                addIfCondition(branch0, {
                    exp: "(" + typeBinding + ")==='radio'" + ifConditionExtra, block: branch1
                });
                // 3. other
    ...
    var directives$1 = {
        model: model, text: text, html: html
    };
